...
|-------------------|-----------------------|---------------------|-------------------|-------------------|
| POSTGRES_PASSWORD | authpass123           | auth-db             | IV-01, IV-03      | DB access         |
| POSTGRES_PASSWORD | txpass123             | transaction-db      | IV-01, IV-03      | DB access         |
| DB_PASSWORD       | authpass123           | auth-service        | IV-01, IV-03      | DB access         |
| JWT_SECRET        | super-secret-key-123  | auth-service        | AV-07, IV-03      | Token forgery     |
| DB_PASSWORD       | txpass123             | transaction-service | IV-01, IV-03      | DB access         |
| SESSION_SECRET    | changeme              | frontend            | FV-03, IV-03      | Session hijack    |


| SESSION_SECRET    | sqp_examplesonarqubetoken1234567890abcdef| Code base            | FV-03, IV-03      | Session hijack    |
