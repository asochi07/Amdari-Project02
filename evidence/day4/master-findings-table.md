...
|---|---|---|---|---|---|---|---|---|---|
| 1 | Gitleaks | aws-access-token | AWS_ACCESS_KEY_ID=AKIAIOSFODNN7EXAMPLE | CRITICAL | .env | 15 | IV-04 | DevSecOps | Hard-fail |
| 2 | Gitleaks | jwt-secret | JWT_SECRET=super-secret-key-123 | CRITICAL | .env | 35 | AV-07, IV-04 | DevSecOps | Hard-fail |
| 3 | Gitleaks | flask-secret-key | SESSION_SECRET=changeme | CRITICAL | .env | 40 | FV-03, IV-04 | DevSecOps | Hard-fail |
| 4 | Gitleaks | db-password-env | AUTH_DB_PASSWORD=authpass123 | CRITICAL | .env | 20 | IV-01, IV-04 | DevSecOps | Hard-fail |
| 5 | Gitleaks | db-password-env | TRANSACTION_DB_PASSWORD=txpass123 | CRITICAL | .env | 26 | IV-01, IV-04 | DevSecOps | Hard-fail |
| 6 | Gitleaks | sonarqube-token | SONAR_TOKEN=sqp_example... | HIGH | .env | 44 | IV-04 | DevSecOps | Hard-fail |
| 7 | Gitleaks | jwt-secret | JWT_SECRET: super-secret-key-123 | CRITICAL | docker-compose.yml | 45 | AV-07, IV-03 | DevSecOps | Hard-fail |
| 8 | Gitleaks | flask-secret-key | SESSION_SECRET: changeme | CRITICAL | docker-compose.yml | 69 | FV-03, IV-03 | DevSecOps | Hard-fail |
| 9 | Gitleaks | db-password-env | POSTGRES_PASSWORD: authpass123 | CRITICAL | docker-compose.yml | 18 | IV-01, IV-03 | DevSecOps | Hard-fail |
| 10 | Gitleaks | db-password-env | POSTGRES_PASSWORD: txpass123 | CRITICAL | docker-compose.yml | 30 | IV-01, IV-03 | DevSecOps | Hard-fail |
| 11 | Gitleaks | db-password-env | DB_PASSWORD: authpass123 | CRITICAL | docker-compose.yml | 44 | IV-01, IV-03 | DevSecOps | Hard-fail |
| 12 | Gitleaks | db-password-env | DB_PASSWORD: txpass123 | CRITICAL | docker-compose.yml | 58 | IV-01, IV-03 | DevSecOps | Hard-fail |
| 13 | Gitleaks | jwt-secret | JWT_SECRET: "super-secret-key-123" | CRITICAL | infra/kubernetes/base/configmap.yaml | 9 | AV-07, CK-09 | DevSecOps | Hard-fail |
| 14 | Gitleaks | flask-secret-key | SESSION_SECRET: "changeme" | CRITICAL | infra/kubernetes/base/configmap.yaml | 10 | FV-03, CK-09 | DevSecOps | Hard-fail |
| 15 | Gitleaks | db-password-env | AUTH_DB_PASSWORD: "authpass123" | CRITICAL | infra/kubernetes/base/configmap.yaml | 11 | IV-01, CK-09 | DevSecOps | Hard-fail |
| 16 | Gitleaks | db-password-env | TX_DB_PASSWORD: "txpass123" | CRITICAL | infra/kubernetes/base/configmap.yaml | 12 | IV-01, CK-09 | DevSecOps | Hard-fail |
| 17 | Gitleaks | hashicorp-tf-password | db_password = "postgres" | CRITICAL | infra/terraform/main.tf | 66 | IV-01, IV-08 | DevSecOps | Hard-fail |
| 18 | Gitleaks | flask-secret-key | SECRET_KEY = 'super-secret-key-123' | MEDIUM | VULNERABILITIES.md | 19 | AV-07 | DevSecOps | Hard-fail |
| 19 | Gitleaks | flask-secret-key | SESSION_SECRET='changeme' | MEDIUM | VULNERABILITIES.md | 40 | FV-03 | DevSecOps | Hard-fail |
| 20 | Gitleaks | db-password-env | db_password = "postgres" | CRITICAL | infra/terraform/main.tf | 66 | IV-01 | DevSecOps | Hard-fail |
