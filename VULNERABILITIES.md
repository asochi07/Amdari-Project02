...
| AV-07 | Hardcoded JWT secret                   | `SECRET_KEY = 'REDACTED-ROTATED-SECRET'` fallback |
...
| FV-03 | Session hijacking                      | `SESSION_SECRET='REDACTED-ROTATED-SECRET'` in docker-compose.yml |
